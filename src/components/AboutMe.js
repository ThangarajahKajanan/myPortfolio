...
const AboutMe = () => {
    ...
    return (
        <div id="AboutMe"  className="w-full bg-slate-50 ">
                        ...
                        <div className="w-full px-4 lg:w-6/12">
                            <div  className="flex items-center -mx-3 sm:-mx-4">
                                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                                    <div data-aos="zoom-in" data-aos-duration="1500" className="py-3 sm:py-4">
                                        <img
                                            src="/imgA.jpg"
                                            alt=""
                                ...
                                <div className="w-full px-3 sm:px-4 xl:w-1/2">
                                    <div data-aos="zoom-in" data-aos-duration="1500" className="relative z-10 my-4">
                                        <img
                                            src="./img1.png"
                                            alt=""
                                            className="w-full rounded-2xl"
                        ...
                        <div  data-aos="fade-up" data-aos-duration="1500"  className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div   className="mt-10 lg:mt-0">
                                ...
                                <p  className="mb-5 text-base text-body-color ">
                                    Highly motivated final-year IT undergraduate specializing in software development. Proficient in developing
                                    user-friendly interfaces and optimizing backend operations. Strong in problem-solving, quick learning, and
                                    team collaboration abilities.
                                </p>
                                <p className="mb-8 text-base text-body-color ">
                                    Seeking a Software Engineer internship to apply technical skills, contribute to
                                    innovative web projects, and gain valuable industry experience.
                                </p>
                                <div className="pT-8">
                                 <TimeLine />
                                </div>
